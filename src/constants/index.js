...
export const roadmap = [
  {
    ...
    content: [
      {
        id: "activity-1",
        activity: "Develop and Deploy Smart Contract Development",
        time: "Q1 2024",
        icon: checkmark,
        icon2: logo_token,
      ...
      {
        id: "activity-2",
        activity: "Launch cancer-focused educational channels",
        time: "Q1 2024",
        icon: checkmark,
        icon2: youtube,
  ...
  },
  {
    ...
    content: [
      {
        id: "activity-1",
        activity: "Token sales/Vesting contract deployment",
        time: "Q2 2024",
      },
      ...
      {
        id: "activity-2",
        activity: "Deploy liquinity pairs for DEX of ATCG",
        time: "Q2 2024",
      },
      {
        id: "activity-3",
        activity: "Publishing RFAs (requests for applications)",
        time: "Q2 2024 -",
      },
      {
        id: "activity-4",
        activity: "Select and fund research and development applications",
        time: "Q2 2024 -",
      },
    ],
  },
    ...
    content: [
      {
        id: "activity-1",
        activity:
          "Mechanisms to passively reward reproducible research",
        time: "Q3 2024-",
      },
    ],
  },
...
export const benefits = [
  {
    ...
    content:
      "Be an active participant in the governance and funding decisions that determine the future of CancerDAO and cancer research. Your vote is vital to our joint efforts",
  },
  {
    id: "Connect with people from all over the world with the common misstion to make cancer history",
    content:
      "You will have the opportunity to connect with scientists, patients and physicians, creating a collaborative environment for sharing insights and perspectives",
  },
  {
    id: "Own a share of the value generated by CancerDAO-sponsored research",
    content:
      " The ATCG token symbolzies your dedication to cancer cure as well as your ownership of a share of the value generated by the resaerch. In turn, your stake ensures the healthy growth of the CancerDAO ecosystem",
  },
  {
    id: "Qualified for services provided by research teams and attend education programs provided by CancerDAO",
    content:
      "You will have the privilege of using the services provided by resaerch teams and attending educational programs sponsored by CancerDao",
  },
];
...
export const tokenomics_progs = [
  {
    id: "tokenomics-1",
    content: "In exchange for ATCG, CancerDAO will receive initial funding from the community and contributors",
    },

    {
    id: "tokenomics-2",
    content: "These funds will be used to implement the first and subsequent R&D projects",
    },
    {
    id: "tokenomics-3",
    content: "It is expected that the research projects will generate passive income in exchange for services/tools/intellectual property and as recognition of the validation of their work",
    },
    {
    id: "tokenomics-4",
    content: "The treasury will grow through revenues from other CancerDAO-sponsored events",
    },
]
...
export const teamData = [
  {
    ...
    position:
      "Founder, Web2/Web3/Smart Contract Developer, Principal Investigator, Laboratory of Cancer Genomics and Artificial Intelligence. Training: University of Pennsylvania, The Rockefeller University. Discovered AML1-ETO/ETO-E-protein interaction, a potential drug target in acute myeloid leukemia",
    socials: [
      {
        color: "red",
        name: "google",
